...
|---|---|---|---|
| **Conformance suite** | Technical test execution against the engine, adapters, API and invariants | **1073 collected · 1073 executed · 1073 passed** · 0 failed, skipped, xfailed, xpassed | 2026-09-04, commit `e68a65d` |
...
**These are four different denominators.** 1073/1073 is a *test pass rate*, not
...
|---|---|---|
| **Conformance suite** | 1073 tests | Does the implementation behave as specified? |
