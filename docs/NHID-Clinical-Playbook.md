...
|---|---|---|---|
| **Conformance suite** | Technical test execution against the engine, adapters, API and invariants | **1094 collected · 1094 executed · 1094 passed** · 0 failed, skipped, xfailed, xpassed | 2026-09-04, commit `e68a65d` |
...
**These are four different denominators.** 1094/1094 is a *test pass rate*, not
...
|---|---|---|
| **Conformance suite** | 1094 tests | Does the implementation behave as specified? |
