...
**Status**: Pilot Ready (759 tests passing, 777 total; schema adapter operational)
...
**Test Coverage**: 759 passing tests, 18 skipped (777 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (759 tests passing, 777 total)
...
│
├─ tests/                     (42 files, 777 tests: 759 passing, 18 skipped)
...
759 passing, 18 skipped, 777 total.
