...
**Status**: Pilot Ready (779 tests passing, 797 total; schema adapter operational)
...
**Test Coverage**: 779 passing tests, 18 skipped (797 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (779 tests passing, 797 total)
...
│
├─ tests/                     (43 files, 797 tests: 779 passing, 18 skipped)
...
779 passing, 18 skipped, 797 total.
