...
**Status**: Pilot Ready (920 tests passing, 938 total; schema adapter operational)
...
**Test Coverage**: 920 passing tests, 18 skipped (938 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (920 tests passing, 938 total)
...
│
├─ tests/                     (54 files, 938 tests: 920 passing, 18 skipped)
...
920 passing, 18 skipped, 938 total.
