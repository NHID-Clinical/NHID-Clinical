...
**Status**: Pilot Ready (743 tests passing, 761 total; schema adapter operational)
...
**Test Coverage**: 743 passing tests, 18 skipped (761 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (743 tests passing, 761 total)
...
│
├─ tests/                     (41 files, 761 tests: 743 passing, 18 skipped)
...
743 passing, 18 skipped, 761 total.
