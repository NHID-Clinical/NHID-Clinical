...
**Status**: Pilot Ready (1031 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1031 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1031 tests passing)
...
│
├─ tests/                     (55 files, 1031 tests, all passing)
...
1031 passing, 0 skipped, 0 xfailed.
