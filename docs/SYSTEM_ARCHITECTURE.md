...
**Status**: Pilot Ready (848 tests passing, 866 total; schema adapter operational)
...
**Test Coverage**: 848 passing tests, 18 skipped (866 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (848 tests passing, 866 total)
...
│
├─ tests/                     (61 files, 866 tests: 848 passing, 18 skipped)
...
848 passing, 18 skipped, 866 total.
