...
**Status**: Pilot Ready (1160 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1160 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1160 tests passing)
...
│
├─ tests/                     (55 files, 1160 tests, all passing)
...
1160 passing, 0 skipped, 0 xfailed.
