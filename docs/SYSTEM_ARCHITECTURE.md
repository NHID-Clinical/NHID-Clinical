...
**Status**: Pilot Ready (790 tests passing, 808 total; schema adapter operational)
...
**Test Coverage**: 790 passing tests, 18 skipped (808 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (790 tests passing, 808 total)
...
│
├─ tests/                     (58 files, 808 tests: 790 passing, 18 skipped)
...
790 passing, 18 skipped, 808 total.
