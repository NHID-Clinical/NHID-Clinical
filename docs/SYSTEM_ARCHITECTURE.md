...
**Status**: Pilot Ready (1145 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1145 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1145 tests passing)
...
│
├─ tests/                     (55 files, 1145 tests, all passing)
...
1145 passing, 0 skipped, 0 xfailed.
