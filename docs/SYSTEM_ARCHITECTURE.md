...
**Status**: Pilot Ready (921 tests passing, 939 total; schema adapter operational)
...
**Test Coverage**: 921 passing tests, 18 skipped (939 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (921 tests passing, 939 total)
...
│
├─ tests/                     (54 files, 939 tests: 921 passing, 18 skipped)
...
921 passing, 18 skipped, 939 total.
