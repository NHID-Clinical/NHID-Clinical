...
**Status**: Pilot Ready (1094 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1094 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1094 tests passing)
...
│
├─ tests/                     (55 files, 1094 tests, all passing)
...
1094 passing, 0 skipped, 0 xfailed.
