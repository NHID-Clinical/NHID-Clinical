...
**Status**: Pilot Ready (718 tests passing, 736 total; schema adapter operational)
...
**Test Coverage**: 718 passing tests, 18 skipped (736 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (718 tests passing, 736 total)
...
│
├─ tests/                     (40 files, 736 tests: 718 passing, 18 skipped)
...
718 passing, 18 skipped, 736 total.
