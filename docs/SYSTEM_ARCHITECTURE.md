...
**Status**: Pilot Ready (1148 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1148 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1148 tests passing)
...
│
├─ tests/                     (55 files, 1148 tests, all passing)
...
1148 passing, 0 skipped, 0 xfailed.
