...
**Status**: Pilot Ready (851 tests passing, 869 total; schema adapter operational)
...
**Test Coverage**: 851 passing tests, 18 skipped (869 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (851 tests passing, 869 total)
...
│
├─ tests/                     (61 files, 869 tests: 851 passing, 18 skipped)
...
851 passing, 18 skipped, 869 total.
