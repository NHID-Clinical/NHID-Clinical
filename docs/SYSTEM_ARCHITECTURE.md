...
**Status**: Pilot Ready (822 tests passing, 840 total; schema adapter operational)
...
**Test Coverage**: 822 passing tests, 18 skipped (840 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (822 tests passing, 840 total)
...
│
├─ tests/                     (60 files, 840 tests: 822 passing, 18 skipped)
...
822 passing, 18 skipped, 840 total.
