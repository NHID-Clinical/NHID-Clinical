...
**Status**: Pilot Ready (998 tests passing, 1005 total; schema adapter operational)
...
**Test Coverage**: 998 passing tests, 7 xfailed (1005 total tests)  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (998 tests passing, 1005 total)
...
│
├─ tests/                     (54 files, 1005 tests: 998 passing, 7 xfailed)
...
998 passing, 7 xfailed, 1005 total.
