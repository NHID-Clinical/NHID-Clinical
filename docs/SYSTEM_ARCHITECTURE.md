...
**Status**: Pilot Ready (1020 tests passing, 0 skipped, 0 xfailed; schema adapter operational)
...
**Test Coverage**: 1020 passing tests, 0 skipped, 0 xfailed  
...
NHID-Clinical/
├─ src/
│   └─ nhid_policy_engine_v1.py (1020 tests passing)
...
│
├─ tests/                     (55 files, 1020 tests, all passing)
...
1020 passing, 0 skipped, 0 xfailed.
