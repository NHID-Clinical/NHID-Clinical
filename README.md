...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-998%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **998 passing** (+ 7 xfailed)
...
**Available today**
- Deterministic policy engine with 1005 tests (998 passing) across all phases
...
Comprehensive test suite · same inputs → identical output · **998 passing** + 7 xfailed (1005 total tests)
...
Expected: **998 passing** in ~3.0s (7 recorded divergences; 1005 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (998 passing, 1005 total; all phases: foundations, adversarial, synthetic, hardening). |
