...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-924%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **924 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 942 tests (924 passing) across all phases
...
**Engine Validation**:
- ✅ **924 passing tests** (942 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **924 passing** + 18 skipped (942 total tests)
...
Expected: **924 passing** in ~3.0s (~18 skipped integration tests; 942 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (924 passing, 942 total; all phases: foundations, adversarial, synthetic, hardening). |
