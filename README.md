...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-743%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **743 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 761 tests (743 passing) across all phases
...
**Engine Validation**:
- ✅ **743 passing tests** (761 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **743 passing** + 18 skipped (761 total tests)
...
Expected: **743 passing** in ~3.0s (~18 skipped integration tests; 761 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (743 passing, 761 total; all phases: foundations, adversarial, synthetic, hardening). |
