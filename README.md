...
[![Tests](https://img.shields.io/badge/tests-264%20passing-brightgreen)](https://github.com/NHID-Clinical/NHID-Clinical/actions)
...
5 deterministic CTS tests · same inputs → identical trace output · 264 passing across the Python test suite (198) and TypeScript middleware (66)
...
Expected output: `198 passing` in ~1.4s (requires `cryptography` package for identity tests; ~6 skip when no server is running).
