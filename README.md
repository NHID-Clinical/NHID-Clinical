...
[![Tests](https://img.shields.io/badge/tests-311%20passing-brightgreen)](https://github.com/NHID-Clinical/NHID-Clinical/actions)
...
5 deterministic CTS tests · same inputs → identical trace output · 311 passing across the Python test suite (245) and TypeScript middleware (66)
...
Expected output: `245 passing` in ~1.4s (requires `cryptography` package for identity tests; ~6 skip when no server is running).
