...
<p align="center">
  ...
  <a href="https://github.com/NHID-Clinical/NHID-Clinical/actions"><img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-294%20passing-brightgreen?style=flat-square"></a>
...
18-case CTS suite · same inputs → identical trace output · 294 passing in the Python test suite (18 skipped without a running server) + 66 passing in the TypeScript middleware
...
Expected output: `294 passing` in ~1.4s (requires `cryptography` package for identity tests; ~18 skip when no server is running).
