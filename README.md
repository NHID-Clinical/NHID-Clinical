...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-847%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **847 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 865 tests (847 passing) across all phases
...
**Engine Validation**:
- ✅ **847 passing tests** (865 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **847 passing** + 18 skipped (865 total tests)
...
Expected: **847 passing** in ~3.0s (~18 skipped integration tests; 865 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (847 passing, 865 total; all phases: foundations, adversarial, synthetic, hardening). |
