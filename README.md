...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-920%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **920 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 938 tests (920 passing) across all phases
...
**Engine Validation**:
- ✅ **920 passing tests** (938 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **920 passing** + 18 skipped (938 total tests)
...
Expected: **920 passing** in ~3.0s (~18 skipped integration tests; 938 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (920 passing, 938 total; all phases: foundations, adversarial, synthetic, hardening). |
