...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-790%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **790 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 808 tests (790 passing) across all phases
...
| **2** | **Detection Rate Report** | ✅ Complete | 81.2% aggregate detection (26/32 violations); 20% false-positive rate (1 of 5 compliant scenarios); per-rule accuracy breakdown |
...
**Engine Validation**:
- ✅ **790 passing tests** (808 total; comprehensive rule coverage across all phases)
- ✅ **25-scenario evaluation corpus** (81.2% detection; 20% false positives, 1 of 5 compliant scenarios)
- ✅ **Live endpoint tested** against noncompliant VAPI payload
- ✅ **Deterministic** — same input always produces same output

**Governance Readiness**:
- ✅ **Strong rules**: DBC-01 (100%), EIT-01 (100%)
- ⚠️ **Weaker rules**: IDG-01 (62.5%), PDX-01 (66.7%) — IDG-01 checks that a disclosure exists, not that its wording is adequate; scenarios disclosing with weak wording are counted as misses
...
Comprehensive test suite · same inputs → identical output · **790 passing** + 18 skipped (808 total tests)
...
Expected: **790 passing** in ~3.0s (~18 skipped integration tests; 808 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (790 passing, 808 total; all phases: foundations, adversarial, synthetic, hardening). |
