...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-851%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **851 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 869 tests (851 passing) across all phases
...
**Engine Validation**:
- ✅ **851 passing tests** (869 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **851 passing** + 18 skipped (869 total tests)
...
Expected: **851 passing** in ~3.0s (~18 skipped integration tests; 869 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (851 passing, 869 total; all phases: foundations, adversarial, synthetic, hardening). |
