...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-822%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **822 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 840 tests (822 passing) across all phases
...
**Engine Validation**:
- ✅ **822 passing tests** (840 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **822 passing** + 18 skipped (840 total tests)
...
Expected: **822 passing** in ~3.0s (~18 skipped integration tests; 840 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (822 passing, 840 total; all phases: foundations, adversarial, synthetic, hardening). |
