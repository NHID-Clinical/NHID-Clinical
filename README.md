...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-921%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **921 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 939 tests (921 passing) across all phases
...
**Engine Validation**:
- ✅ **921 passing tests** (939 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **921 passing** + 18 skipped (939 total tests)
...
Expected: **921 passing** in ~3.0s (~18 skipped integration tests; 939 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (921 passing, 939 total; all phases: foundations, adversarial, synthetic, hardening). |
