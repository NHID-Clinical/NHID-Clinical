...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-848%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **848 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 866 tests (848 passing) across all phases
...
**Engine Validation**:
- ✅ **848 passing tests** (866 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **848 passing** + 18 skipped (866 total tests)
...
Expected: **848 passing** in ~3.0s (~18 skipped integration tests; 866 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (848 passing, 866 total; all phases: foundations, adversarial, synthetic, hardening). |
