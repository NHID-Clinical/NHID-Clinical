...
<p align="center">
  ...
  <img alt="Python Tests" src="https://img.shields.io/badge/python%20tests-718%20passing-brightgreen?style=flat-square">
...
2. `pip install -r requirements.txt && python -m pytest tests/ -v` → **718 passing** (+ 18 skipped)
...
**Available today**
- Deterministic policy engine with 736 tests (718 passing) across all phases
...
**Engine Validation**:
- ✅ **718 passing tests** (736 total; comprehensive rule coverage across all phases)
...
Comprehensive test suite · same inputs → identical output · **718 passing** + 18 skipped (736 total tests)
...
Expected: **718 passing** in ~3.0s (~18 skipped integration tests; 736 total). Live demos and full docs on [nhid-clinical.org](https://nhid-clinical.org).
...
| `tests/` | The Python conformance and invariant tests (718 passing, 736 total; all phases: foundations, adversarial, synthetic, hardening). |
