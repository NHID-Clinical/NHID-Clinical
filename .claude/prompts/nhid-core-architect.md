...
- The AI Governance Map and the other formerly Vercel-hosted projects are separate projects on their
  own deployments. Do not present them as NHID-Clinical capabilities, and do not add them to this
  site's navigation, footer, or cross-links. Framework alignment lives in `/regulatory-alignment.html`.
